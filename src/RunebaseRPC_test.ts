...
describe("RunebaseRPC", () => {
  ...
  it("can convert a hex address to a p2pkh address", async () => {
    ...
    assert.strictEqual(p2pkhAddress, "nkSG9fEdKKiBd3TBjdHvgj3J8vPgAmmnCT")
  })

  it("can convert a p2pkh address to a hex address", async () => {
    const hexAddress = await rpc.getHexAddress("nkSG9fEdKKiBd3TBjdHvgj3J8vPgAmmnCT")
