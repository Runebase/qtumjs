...
const {
  logDecoder,
} = require("runebasejs-ethjs-abi") as IETHABI
...
export interface IContractSendRequestOptions {
  /**
   * The amount in RUNEBASE to send. eg 0.1, default: 0
   */
  ...
  /**
   * Runebase price per gas unit, default: 0.00000001, min:0.00000001
   */
...
export class Contract {
   ...
   *      [solar](https://github.com/runebaseproject/solar). It includes the contract
   *      address, owner address, and ABI definition for methods and types.
   * @param opts - init options
   */
  constructor(private rpc: RunebaseRPC, public info: IContractInfo, opts: IContractInitOptions = {}) {
  ...
  /**
   * Executes contract method on your own local runebased node as a "simulation"
